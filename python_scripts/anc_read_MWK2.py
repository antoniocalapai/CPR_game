...
EuclDist = pd.DataFrame(columns=['trial', 'distance', 'angle', 'time', 'outcome', 'SNR_time',
...
ax = sns.lineplot(x="time", y="distance", hue="SNR", units="trial", estimator=None,
